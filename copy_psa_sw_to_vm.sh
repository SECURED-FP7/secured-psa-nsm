...
# NOTE: Change img name accordingly BroMalware/BroLogging
# Remember to update PSA/psaEE.conf too:
# psa_id=BroMalware/BroLogging
# psa_name=Bro PSA

IMG="/var/lib/libvirt/images/BroMalware.img"
