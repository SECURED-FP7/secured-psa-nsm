...
class getConfiguration():
    ...
    def pullPSAconf( self, execIf ):
        ...
        # NOTE: pylint will complain about 'requests.codes.ok' since it has no
        #       way of knowning statically that it exists as request.codes is
...
#            self.callInitScript()
    ...
    #TODO: this should be the same as in execInterface.py!!!
